...
open class PXCampaign: NSObject, Codable {
   ...
   @objc
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.discountType, forKey: .discountType)
        try container.encodeIfPresent(self.value, forKey: .value)
        try container.encodeIfPresent(self.minPaymentAmount, forKey: .minPaymentAmount)
        try container.encodeIfPresent(self.maxPaymentAmount, forKey: .maxPaymentAmount)
        try container.encodeIfPresent(self.maxCouponAmount, forKey: .maxCouponAmount)
        try container.encodeIfPresent(self.totalAmountLimit, forKey: .totalAmountLimit)
        try container.encodeIfPresent(self.maxCoupons, forKey: .maxCoupons)
        try container.encodeIfPresent(self.maxCouponsByCode, forKey: .maxCouponsByCode)
        try container.encodeIfPresent(self.maxRedeemPerUser, forKey: .maxRedeemPerUser)
        try container.encodeIfPresent(self.siteId, forKey: .siteId)
        try container.encodeIfPresent(self.marketplace, forKey: .marketplace)
        try container.encodeIfPresent(self.codeType, forKey: .codeType)
        try container.encodeIfPresent(self.maxUserAmountPerCampaign, forKey: .maxUserAmountPerCampaign)
        try container.encodeIfPresent(self.labels, forKey: .labels)
        try container.encodeIfPresent(self.paymentMethodsIds, forKey: .paymentMethodsIds)
        try container.encodeIfPresent(self.paymentTypesIds, forKey: .paymentTypesIds)
        try container.encodeIfPresent(self.cardIssuersIds, forKey: .cardIssuersIds)
        try container.encodeIfPresent(self.shippingModes, forKey: .shippingModes)
        try container.encodeIfPresent(self.clientId, forKey: .clientId)
        try container.encodeIfPresent(self.tags, forKey: .tags)
        try container.encodeIfPresent(self.multipleCodeLimit, forKey: .multipleCodeLimit)
        try container.encodeIfPresent(self.codeCount, forKey: .codeCount)
        try container.encodeIfPresent(self.couponAmount, forKey: .couponAmount)
        try container.encodeIfPresent(self.collectors, forKey: .collectors)
        try container.encodeIfPresent(self.legalTermsUrl, forKey: .legalTermsUrl)
    }
