...
class TermsAndConditionsViewCell: UITableViewCell, UITextViewDelegate {
    ...
    override func awakeFromNib() {
        ...
        let URLAttribute = [NSAttributedStringKey.font: UIFont(name:MercadoPago.DEFAULT_FONT_NAME, size: 12) ?? UIFont.systemFont(ofSize: 12), NSAttributedStringKey.foregroundColor: UIColor.primaryColor()]
...
//        self.termsAndConditionsText.linkTextAttributes = URLAttribute
    ...
    private static func getTyCText() -> NSMutableAttributedString {
        ...
        let normalAttributes: [NSAttributedStringKey:AnyObject] = [NSAttributedStringKey.font: Utils.getFont(size: 12), NSAttributedStringKey.foregroundColor: UIColor.px_grayLight()]
