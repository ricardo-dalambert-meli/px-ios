...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AndesUI/AndesUI.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MLBusinessComponents/MLBusinessComponents.framework"
